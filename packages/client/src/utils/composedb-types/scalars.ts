...
import type { ScalarSchema } from "./types";
...
export const SCALAR_RUNTIME_TYPES: Record<
  ScalarTitle,
...
export function getGraphQLScalarSchema<T extends ScalarSchema = ScalarSchema>(
  ...
  if (schema == null) {
    throw new Error(
      `Missing JSON schema in scalar extensions for type: ${type}`
    );
  }
...
export const extraScalars: Record<string, ScalarWithTitle> = {
  ...
  CountryCode: {
    ...getGraphQLScalarSchema<JSONSchema.String>("countrycode"),
    maxLength: 2,
  },
  Date: {
  ...
  LocalDate: {
    ...getGraphQLScalarSchema<JSONSchema.String>("localdate"),
    maxLength: 100,
  },
  Locale: {
    ...getGraphQLScalarSchema<JSONSchema.String>("locale"),
    maxLength: 100,
  },
  LocalTime: {
    ...getGraphQLScalarSchema<JSONSchema.String>("localtime"),
    maxLength: 100,
  },
  Longitude: getGraphQLScalarSchema("longitude"),
  StreamID: { type: "string", title: "CeramicStreamID", maxLength: 100 },
  Time: {
    ...getGraphQLScalarSchema<JSONSchema.String>("time"),
    maxLength: 100,
  },
  TimeZone: {
...
export function getScalarSchema(
